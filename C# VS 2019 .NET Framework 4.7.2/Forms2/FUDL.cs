...
namespace Graphical_2D_Frame_Analysis_CSharp
{
    public partial class FUDL : Form
    {
        ...
        private void FUDL_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(Form1.Pload2[Form1.Last_index_line_selected + 1]))
                {
                    ...
                    udl1 = InputParsingHelpers.ParseDoubleOrDefault(test[7].Replace(" ", ""));
                    udl2 = InputParsingHelpers.ParseDoubleOrDefault(test[8].Replace(" ", ""));
                    d1 = InputParsingHelpers.ParseDoubleOrDefault(test[9].Replace(" ", ""));
                    d2 = InputParsingHelpers.ParseDoubleOrDefault(test[10].Replace(" ", ""));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            udl1 = InputParsingHelpers.ParseDoubleOrDefault(textBox1.Text.Replace(" ", ""));
            udl2 = InputParsingHelpers.ParseDoubleOrDefault(textBox3.Text.Replace(" ", ""));
            ...
            if (InputParsingHelpers.ParseDoubleOrDefault(textBox1.Text.Replace(" ", "")) == 0 & InputParsingHelpers.ParseDoubleOrDefault(textBox3.Text.Replace(" ", "")) == 0)
            {
            ...
            if (InputParsingHelpers.ParseDoubleOrDefault(textBox2.Text.Replace(" ", "")) >= Form1.L_n(Form1.Last_index_line_selected + 1))
            {
            ...
            if (InputParsingHelpers.ParseDoubleOrDefault(textBox4.Text.Replace(" ", "")) > Form1.L_n(Form1.Last_index_line_selected + 1))
            {
                double c = Form1.L_n(Form1.Last_index_line_selected + 1);
            ...
            if (InputParsingHelpers.ParseDoubleOrDefault(textBox2.Text.Replace(" ", "")) >= InputParsingHelpers.ParseDoubleOrDefault(textBox4.Text.Replace(" ", "")))
            {
            ...
            if (string.IsNullOrEmpty(Form1.Pload2[Form1.Last_index_line_selected + 1]) == false)
            {
                ...
                udl1 = InputParsingHelpers.ParseDoubleOrDefault(textBox1.Text.Replace(" ", ""));
                udl2 = InputParsingHelpers.ParseDoubleOrDefault(textBox3.Text.Replace(" ", ""));
                d1 = InputParsingHelpers.ParseDoubleOrDefault(textBox2.Text.Replace(" ", ""));
                d2 = InputParsingHelpers.ParseDoubleOrDefault(textBox4.Text.Replace(" ", ""));
