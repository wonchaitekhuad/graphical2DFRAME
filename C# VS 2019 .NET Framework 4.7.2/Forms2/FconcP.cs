        ...
        private void FconcP_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(Form1.Pload2[Form1.Last_index_line_selected + 1]))
                {
                    ...
                    textBox1.Text = (InputParsingHelpers.ParseDoubleOrDefault(test[1].Replace(" ", ""))).ToString();
                    textBox2.Text = test[2];
                    textBox3.Text = (InputParsingHelpers.ParseDoubleOrDefault(test[3].Replace(" ", ""))).ToString();
                    textBox4.Text = test[4];
                    textBox5.Text = (InputParsingHelpers.ParseDoubleOrDefault(test[5].Replace(" ", ""))).ToString();
...
try
{
            ...
            if (InputParsingHelpers.ParseDoubleOrDefault(t1) == 0)
            {
                MessageBox.Show(" CONC LOAD P1 must be GRATER THAN ZERO !!!");
                return;
            }

            if (InputParsingHelpers.ParseDoubleOrDefault(t1) != 0 & (InputParsingHelpers.ParseDoubleOrDefault(t2) >= d | InputParsingHelpers.ParseDoubleOrDefault(t2) == 0))
            {
                MessageBox.Show(" Distance must be MORE than ZERO or LESS than BEAM LENGTH!!!");
                return;
            }
            if (InputParsingHelpers.ParseDoubleOrDefault(t3) != 0 & (InputParsingHelpers.ParseDoubleOrDefault(t4) >= d | InputParsingHelpers.ParseDoubleOrDefault(t4) == 0))
            {
                MessageBox.Show(" Distance must be MORE than ZERO or LESS than BEAM LENGTH!!!");
                return;
            }
            if (InputParsingHelpers.ParseDoubleOrDefault(t5) != 0 & (InputParsingHelpers.ParseDoubleOrDefault(t6) >= d | InputParsingHelpers.ParseDoubleOrDefault(t6) == 0))
            {
                MessageBox.Show(" Distance must be MORE than ZERO or LESS than BEAM LENGTH!!!");
                return;
            }
            if (InputParsingHelpers.ParseDoubleOrDefault(t2) != 0 & InputParsingHelpers.ParseDoubleOrDefault(t4) != 0 & InputParsingHelpers.ParseDoubleOrDefault(t6) != 0)
            {
                if ((InputParsingHelpers.ParseDoubleOrDefault(t2) != InputParsingHelpers.ParseDoubleOrDefault(t4)) & (InputParsingHelpers.ParseDoubleOrDefault(t4) != InputParsingHelpers.ParseDoubleOrDefault(t6)) & (InputParsingHelpers.ParseDoubleOrDefault(t6) != InputParsingHelpers.ParseDoubleOrDefault(t2)))
                {
                ...
                {
                    Debug.Print("11" + (InputParsingHelpers.ParseDoubleOrDefault(t2) != InputParsingHelpers.ParseDoubleOrDefault(t4)));
                    Debug.Print("12" + (InputParsingHelpers.ParseDoubleOrDefault(t4) != InputParsingHelpers.ParseDoubleOrDefault(t6)));
                    Debug.Print("13" + (InputParsingHelpers.ParseDoubleOrDefault(t6) != InputParsingHelpers.ParseDoubleOrDefault(t2)));
            ...
            if (!string.IsNullOrEmpty(Form1.Pload2[Form1.Last_index_line_selected + 1])) 
            {
                ...
                test[1] = (fac * InputParsingHelpers.ParseDoubleOrDefault(t1.Replace(" ", ""))).ToString();
                test[2] = t2;
                test[3] = (fac * InputParsingHelpers.ParseDoubleOrDefault(t3.Replace(" ", ""))).ToString();
                test[4] = t4;
                test[5] = (fac * InputParsingHelpers.ParseDoubleOrDefault(t5.Replace(" ", ""))).ToString();
                test[6] = t6;
