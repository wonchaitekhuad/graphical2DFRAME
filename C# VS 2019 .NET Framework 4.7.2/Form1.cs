            ...
            try
            {
                for (int j = 1; j <= totalnode; j++)
                {
                    if (!string.IsNullOrEmpty(Support_Displacement_S[j]))
                    {
                        ...
                        dispx = InputParsingHelpers.ParseDoubleOrDefault(test9[1]);
                        dispy = InputParsingHelpers.ParseDoubleOrDefault(test9[2]);
            ...
            if (!string.IsNullOrEmpty(Sup_Node_Number_Type[k]))
            {
                ...
                try
                {
                    ...
                    if (suptype[k] == 7)
                    {
                        ...
                        Inc_Supp_angle_base_AND_GX = InputParsingHelpers.ParseDoubleOrDefault(testx[2]);
                        if (InputParsingHelpers.ParseDoubleOrDefault(Theta(midx).ToString("0.00")) - Inc_Supp_angle_base_AND_GX <= 0.2)
                        {
                            bool_has_7 = true;
        ...
        private void Draw_Force_Mem_Pconc_UDL_MCon(int Memb_id, string StringPload, Graphics g)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(StringPload))
                {
                    ...
                    Pcn_1 = -InputParsingHelpers.ParseDoubleOrDefault(test[1]);
                    Xpcn_1 = InputParsingHelpers.ParseDoubleOrDefault(test[2]);
                    Pcn_2 = -InputParsingHelpers.ParseDoubleOrDefault(test[3]);
                    Xpcn_2 = InputParsingHelpers.ParseDoubleOrDefault(test[4]);
                    Pcn_3 = -InputParsingHelpers.ParseDoubleOrDefault(test[5]);
                    Xpcn_3 = InputParsingHelpers.ParseDoubleOrDefault(test[6]);

                    W0_1 = -InputParsingHelpers.ParseDoubleOrDefault(test[7]);
                    W1_1 = -InputParsingHelpers.ParseDoubleOrDefault(test[8]);
                    Xw0_1 = InputParsingHelpers.ParseDoubleOrDefault(test[9]);
                    Xw1_1 = InputParsingHelpers.ParseDoubleOrDefault(test[10]);

                    MCn_1 = InputParsingHelpers.ParseDoubleOrDefault(test[11]);
                    XMcn_1 = InputParsingHelpers.ParseDoubleOrDefault(test[12]);
                ...
                try
                {
                    ...
                    for (i = 1; i <= totalmember; i++)
                    {
                        ...
                        if (!string.IsNullOrEmpty(Mproperty_A_I_E[i]))
                        {
                            ...
                            Ayz[i] = InputParsingHelpers.ParseDoubleOrDefault(test[1]);
                            Iz[i] = InputParsingHelpers.ParseDoubleOrDefault(test[2]);
                            Ey[i] = InputParsingHelpers.ParseDoubleOrDefault(test[3]);
        ...
        public static double[] Joint_Global_force_0_3(string pj)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(pj))
                {
                    ...
                    k = int.Parse(test[0]);
                    Pjx = InputParsingHelpers.ParseDoubleOrDefault(test[1]);
                    Pjy = InputParsingHelpers.ParseDoubleOrDefault(test[2]);
                    Mjzz = InputParsingHelpers.ParseDoubleOrDefault(test[3]);
                    Flocal[0] = k;
                    Flocal[1] = Pjx;
                    Flocal[2] = Pjy;
                    Flocal[3] = Mjzz;
        ...
        private void Run_Analysis_HINGE()
        {
            ...
            for (j = 1; j <= totalnode; j++)
            {
                if (!string.IsNullOrEmpty(Support_Displacement_S[j]))
                {
                    ...
                    Support_Displacement_temp[j * 3 - 2] = InputParsingHelpers.ParseDoubleOrDefault(test9[1]);
                    Support_Displacement_temp[j * 3 - 1] = InputParsingHelpers.ParseDoubleOrDefault(test9[2]);
                }
            }
        ...
        private void Run_Analysis()
        {
            ...
            for (j = 1; j <= totalnode; j++)
            {
                if (!string.IsNullOrEmpty(Support_Displacement_S[j]))
                {
                    ...
                    //Debug.Print(j + ","+(j * 3 - 2)+ "Support_Displacement[j * 3 - 2]  =" + InputParsingHelpers.ParseDoubleOrDefault(test9[1]));
                    //Debug.Print(j + "," + (j * 3 - 1) + "Support_Displacement[j * 3 - 1]  =" + InputParsingHelpers.ParseDoubleOrDefault(test9[2]));
                }
            }
            ...
            for (int k = 1; k <= totalnode; k++)
            {
                ...
                if (!string.IsNullOrEmpty(Sup_Node_Number_Type[k]))
                {
                    ...
                    try
                    {
                        if (suptype[k] == 6)
                        {
                            SPRING_Constant = InputParsingHelpers.ParseDoubleOrDefault(testx[2]);
